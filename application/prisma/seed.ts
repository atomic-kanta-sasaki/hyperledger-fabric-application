...
const peerData: Prisma.PeerCreateInput[] = [
  {
    ...
    tlsCertPath: '../certificate/peerOrganizations/org1.example.com/msp/tlscacerts/ca.crt',
  ...
  },
  {
    ...
    tlsCertPath: '../certificate/peerOrganizations/org2.example.com/msp/tlscacerts/ca.crt',
